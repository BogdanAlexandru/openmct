...
define(function () {
    ...
    var TAXONOMY_ID = "simfloorbot:bot",
        PREFIX = "simfloorbot_tlm:";

    function FloorbotTelemetryInitializer(adapter, objectService) {
        ...
        // to the composition of Floorbot
        function initializeTaxonomy(dictionary) {
            ...
            // Look up Floorbot, and populate it accordingly.
    ...
    return FloorbotTelemetryInitializer;
});